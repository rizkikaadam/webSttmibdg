...
<div class="row">
  <div class="large-4 columns" style="/*border-right: 1px solid #E3E5E8;*/">
              ...
              foreach ($tampil_berita as $data) {
                ?>
                  <div class="row">
                    ...
                    <?php
              $id=$data[berita_id];
               $tampil_foto=$berita->tampil_foto_satu($id);
               $hitung_foto_berita=$berita->hitung_foto_berita($id);
               if ($hitung_foto_berita==0) {
                 $fotoBerita="nofoto.gif";
               }
               else{
                foreach ($tampil_foto as $data_foto_satu) {
                $fotoBerita = "$data_foto_satu[foto_berita]";
              }}
              ?>
        <p><img class="thumbnail" src="../admin_sttmibdg/assets/gambar/<?php echo $fotoBerita;?>" style="height:200px;width:100%;"></p>
              </div>
              <div class="large-6 columns">
  ...
  <div class="large-4 columns" style="/*border-right: 1px solid #E3E5E8;*/">
      <ul class="tabs" data-tabs id="example-tabs">
          <li class="tabs-title is-active"><a href="#panel1" aria-selected="true">Artikel</a></li>
        </ul>
        <div class="tabs-content" data-tabs-content="example-tabs">
          <div class="tabs-panel is-active" id="panel1">
            <?php
            ...
            foreach ($tampil_artikel as $data) {
              ...
              <div class="row">
                <div class="large-6 columns">
                  <p> <img class="thumbnail" src="../admin_sttmibdg/assets/gambar/<?php echo "$data[artikel_foto]";?>" alt="<?php echo "$data[artikel_judul]";?>"></p>
                </div>
                <div class="large-6 columns">
                  <!--<span class="secondary label">Penulis</span> <span class="secondary label"><i class="step fi-comment-quotes size-14" ></i>  &nbsp;&nbsp;Comment</span> <span class="secondary label">Baca</span>-->
